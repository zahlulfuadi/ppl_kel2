        ...
        <table border="1" align="center" style="width:900px;margin-bottom:20px;">
            ...
            foreach ($data->result_array() as $d) {
                ...
                if ($group == '-' || $group != $d['nama_kategori']) {
                    $kat = $d['nama_kategori'];
                    $query = $this->db->query("SELECT k.id_kategori,k.nama_kategori,b.nama_barang,SUM(b.stok) AS tot_stok FROM kategori k, barang b WHERE k.id_kategori=b.id_kategori AND k.nama_kategori='$kat'");
                    $t = $query->row_array();
                    $tots = $t['tot_stok'];
                    if ($group != '-')
                        echo "</table><br>";
    ...
    <td width='30%' align='center'>Stok</td>
            ...
            ?>
                <tr>
                    ...
                    <td style="vertical-align:top;text-align:center;"><?php echo $d['stok']; ?></td>
                </tr>
