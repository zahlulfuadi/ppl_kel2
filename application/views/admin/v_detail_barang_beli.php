					...
					<table>
						...
						<tr>
							...
							<?php if ($b['nama_barang'] != "") { ?>
								<td><input type="text" name="harpok" value="<?php echo ($b['harga_pokok'] != "") ? $b['harga_pokok'] : "-"; ?>" style="width:130px;margin-right:5px;" class="form-control input-sm" required></td>
								<td><input type="text" name="harjul" value="<?php echo ($b['harga_jual'] != "") ? $b['harga_jual'] : "-"; ?>" style="width:130px;margin-right:5px;" class="form-control input-sm" required></td>
