...
class CI_Cart
{
	...
	function _save_cart()
	{
		...
		unset($this->_cart_contents['cart_total_pengeluaran']);
		unset($this->_cart_contents['cart_total_pemasukan']);
		...
		foreach ($this->_cart_contents as $key => $val) {
			...
			if ($val['jenis'] == 'pengeluaran') {
				$total_pengeluaran += ($val['price'] * $val['qty']);
			} elseif ($val['jenis'] == 'pemasukan') {
				$total_pemasukan += ($val['price'] * $val['qty']);
			}
			$total = 0;
			$items += $val['qty'];
